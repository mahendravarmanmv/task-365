(function ($) {
  ...
  $(".chat-user").click(function () {
    ...
    $(".chat-right").toggleClass("show");
  });

  $(".mobile-chat-arrow").click(function () {
    $(this).toggleClass("click");
    $(".chat-right").toggleClass("show");
  });
})(jQuery);
...
$(".brand_logo_card ").slick({
  ...
  infinite: true,
  autoplay: true,
  prevArrow: "<img class=' prev slick-prev' src='assets/images/task-img/arrow_right.svg'>",
  nextArrow: "<img class=' next slick-next' src='assets/images/task-img/arrow_left.svg'>",
  responsive: [
    {
      breakpoint: 1025,
      settings: {
